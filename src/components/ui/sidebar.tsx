      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width)] max-w-[85vw] bg-sidebar p-0 text-sidebar-foreground"
            style={
              {
          ...
          >
            ...
            <SheetDescription className="sr-only">Device inventory, staff directory, and account settings.</SheetDescription>
    ...
    return (
      ...
      >
          ...
          style={{
            width: state === "collapsed" && collapsible === "icon"
              ? variant === "floating" || variant === "inset"
                ...
                : "var(--sidebar-width-icon)"
              : "var(--sidebar-width)",
            transition: "width 200ms ease-linear, left 200ms ease-linear, right 200ms ease-linear",
          } as React.CSSProperties}
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh md:flex",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow group-data-[collapsible=icon]:overflow-hidden"
          >
            {children}
          </div>
        </div>
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Randomize the skeleton width after mount to keep render pure
